...
const ServiceDetail = ( { postData, services } ) => {
  ...
  return (
    <Layouts>
		<PageBanner pageTitle={postData.title} pageDesc={"Veja mais detalhes deste serviço!"} />
					...
					<div className="col-xs-12 col-sm-12 col-md-12 col-lg-4">
						...
						<div className="onovo-service-item onovo-service-no-icon gap-bottom-40">
							<div className="onovo-service-item-inner onovo-hover-3 onovo-hover-black">
								<h5 className="title">
									<span data-splitting data-onovo-scroll> Lista de serviços </span>
								</h5>
								<div className="list">
									<ul>
						...
						<div className="onovo-form-box onovo-text-white">
							<h5>Fale agora conosco!</h5>
							<p>Todos as mensagens são respondidas no mesmo dia</p>
							<Formik
